...
return [
    ...
    'route' => [
        ...
        'api_prefix' => env('ADMIN_ROUTE_PREFIX', 'admin'),
    ...
    'auth' => [
        'controller' => App\Admin\AuthController::class,
        'guard' => 'admin',
        'guards' => [
            'admin' => [
                'driver' => 'session',
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model' => Mzh\Admin\Auth\Database\Administrator::class,
            ],
        ],
    ...
    'database' => [
        ...
        'users_model' => Mzh\Admin\Auth\Database\Administrator::class,
        // Role table and model.
        'roles_table' => 'admin_roles',
        'roles_model' => Mzh\Admin\Auth\Database\Role::class,
        // Permission table and model.
        'permissions_table' => 'admin_permissions',
        'permissions_model' => Mzh\Admin\Auth\Database\Permission::class,
        // Menu table and model.
        'menu_table' => 'admin_menu',
        'menu_model' => Mzh\Admin\Auth\Database\Menu::class,
